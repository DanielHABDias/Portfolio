    ...
    return (
      ...
      >
        ...
        >
          ...
          <Box>
            <IconButton size="small" color="inherit" onClick={clearChat} disabled={isLoading}>
              <DeleteForeverIcon /> 
            </IconButton>
        ...
        >
          {messages.length === 0 && !isLoading && (
            <Typography variant="body2" color="rgba(255,255,255,0.7)" sx={{ textAlign: 'center', mt: 'auto', mb: 'auto' }}>
